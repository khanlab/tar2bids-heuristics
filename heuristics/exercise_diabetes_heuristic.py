...
def infotodict(seqinfo):
    ...
    t2w_hipp = create_key('{bids_subject_session_dir}/anat/{bids_subject_session_prefix}_acq-HighResHippocampus_run-{item}_T2w')
    ...
    info = {rest:[],rest_sbref:[],rest_pa_sbref:[],rest_pa:[],
        ...
        t1w_norm:[],t2w_vnavs:[],t2w:[],t2w_norm:[],t2w_hipp:[],
...
#                info[t2w_norm].append({'item': s.series_id}) 
        ...
        elif ('HighResHippocampus' in s.series_description):
            info[t2w_hipp].append({'item': s.series_id})
