...
def infotodict(seqinfo):
    ...
    task_test = create_key('{bids_subject_session_dir}/func/{bids_subject_session_prefix}_task-test_run-{item:02d}_bold')
    ...
    for idx, s in enumerate(seqinfo):
        ...
        if ('test' in (s.series_description).strip() and s.dim4>150):
